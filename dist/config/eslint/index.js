...
var require_eslint_config_prettier = chunk5WRI5ZAA_js.__commonJS({
  "node_modules/eslint-config-prettier/index.js"(exports$1) {
...
// src/config/eslint/base.ts
var import_eslint_config_prettier = chunk5WRI5ZAA_js.__toESM(require_eslint_config_prettier());
var baseConfig = [
...
var reactConfig = [
  ...
  reactRefresh__default.default.configs.vite,
  {
    files: ["**/*.{ts,tsx,jsx}"],
    plugins: {
